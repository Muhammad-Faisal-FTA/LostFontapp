...
// https://lost-and-found-backend-eosin.vercel.app/api/v1/found-items/get-founditems
const Cardsf: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('https://lost-and-found-backend-eosin.vercel.app/api/v1/found-items/get-founditems'); // Replace with your API endpoint
        const result = await response.json();
        setItems(result.data);
        alert("successfull!, but there is no item in the database....")
      } catch (error) {
