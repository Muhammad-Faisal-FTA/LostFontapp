...
//   contactLink,
  imageUrl,
    ...
    return (
        <div className="max-w-sm rounded-xl overflow-hidden shadow-md bg-white hover:shadow-lg transition-shadow duration-300 border border-gray-300">
        {/* Header Section */}
        ...
        {/* Image Section (Gray placeholder with shapes) */}
        <div className="w-full h-32 bg-gray-200 flex justify-center items-center">
          {/* Placeholder Shapes (Triangle, Square, Circle) */}
